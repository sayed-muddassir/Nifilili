...
public class CreateCategoryRequest {
    ...
    @Schema(description = "Identifier of the parent business vertical.", example = "1", nullable = true)
    private Long businessVerticalId;

    @Schema(description = "Optional parent category identifier for nested category trees.", example = "12", nullable = true)
    ...
    @Schema(description = "Whether the category is active and selectable for businesses.", example = "true")
